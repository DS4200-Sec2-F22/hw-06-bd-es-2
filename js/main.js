...
>>>>>>> 1302d8fec16b7947576c59b12b5c273fcca016f0
...
<<<<<<< HEAD
  ...
  const points = FRAME2.selectAll("circle")
    .data(data)
    .enter()
    .append("circle")
  ...
  function changePoints() {
    for (let i = 0; i < length(selectedPoints); i++) {
      for (let j = 0; j < length(selectedPoints); j++) {
        FRAME1.selectAll("#" + j)
          .enter()
